...
import com.fangzuo.assist.Beans.ImgAddress;
import com.fangzuo.assist.R;
import com.fangzuo.assist.Utils.CommonUtil;
import com.jude.easyrecyclerview.adapter.BaseViewHolder;
import com.jude.easyrecyclerview.adapter.RecyclerArrayAdapter;

public class PicServerAdapter extends RecyclerArrayAdapter<ImgAddress> {
    public PicServerAdapter(Context context) {
        super(context);
    }
...
//            tv_model2 =   $(R.id.tv);
        ...
        @Override
        public void setData(ImgAddress data) {
            super.setData(data);
